...
import sliderStyles from "../../Weather/WeatherSlider/WeatherSlider.module.scss";
import PowerData from "../../Power/powerData";
        ...
        {props.currently && (
          <div className="col-5">
            <div className={sliderStyles.slider}>
              <div className={sliderStyles["slider-arrows"]}>
                ...
                <div className={styles.pullRight}>
                  <ul className={[["list-unstyled"], styles["stats"], styles["pullRight"]].join(" ")}>
                    ...
                    <li className="media">
                      ...
                      <div className="media-body">
                        Precipitation
                        <h5>{formatAsPercentage(props.currently.rain)}</h5>
                      </div>
                    </li>
                    <li className="media">
                      <div className={styles["stats-icon"]}>
