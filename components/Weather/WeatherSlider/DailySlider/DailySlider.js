...
const dailySlider = props => {
  ...
  let checkHour = props.weather.hourly;

  console.log(">>>>>>>>>>>>");
  console.log(props.weather.hourly)
  console.log(props.weather.hourly.data)
                  ...
                  <TabPanel>
                    <ul>
                      ...
                      <li>
                        ...
                        <span>{format(fromUnixTime(item.sunrise), "h:m a")}</span>
                      </li>
                      <li>
                        <strong>Sunset</strong>{" "}
                        <span>{format(fromUnixTime(item.sunset), "h:m a")}</span>
                      </li>
                      <li>
                      ...
                      <li>
                        ...
                        <span>
                          {item.uvi} at {format(fromUnixTime(item.uvi), "hh:mm a")}
                        </span>
                      </li>
                      <li>
                            ...
                            <table className="table table-hover table-borderless table-sm">
                              ...
                              <tbody>
                                {checkHour.map((hour, index) => {
                                  if (
                                    format(fromUnixTime(hour.dt), "MMMM do yyyy") ===
                                    format(fromUnixTime(item.dt), "MMMM do yyyy")
                                  ) {
                                    return (
                                      <tr key={hour.dt}>
                                        <th scope="row">
                                          {format(fromUnixTime(hour.dt), "h a")}{" "}
